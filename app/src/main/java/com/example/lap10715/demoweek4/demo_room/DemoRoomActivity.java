...
public class DemoRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lvNotes.setOnItemClickListener((parent, view, position, id) -> {
            PopupMenu popup = new PopupMenu(DemoRoomActivity.this, view);
            ...
            popup.setOnMenuItemClickListener(item -> {
                ...
                switch (id1){
                    case R.id.item_modify:
                        ...
                        Intent intent = new Intent(DemoRoomActivity.this,
                    ...
                    case R.id.item_delete:
                        DeleteDialog deleteDialog = new DeleteDialog(DemoRoomActivity.this,
                                position);
                        deleteDialog.show();
                        return true;
                }
